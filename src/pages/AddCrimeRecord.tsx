...
const MapPicker: React.FC<{ onLocationSelect: (location: LocationMarker) => void }> = ({ onLocationSelect }) => {
  const [position, setPosition] = React.useState<LocationMarker | null>(null);
